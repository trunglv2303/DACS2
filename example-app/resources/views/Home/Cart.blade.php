        ...
        <form action="">
            ...
            @endphp
                    @foreach ($carts as $cart)
                        ...
                        <tr>
                            <td> <img src="/user-asset/img/{{ $cart->sp_hinh }}" alt=""
                            ...
                            <td>
                                <input type="number" class="quantity-input" min="1" max="10"
                                    value="{{ $cart->quantity }}">
                            </td>
                            @php
        ...
        <div class="home-1">
            ...
            <div class="chithich-1">
                ...
                <div class="check1">
                    ...
                    <div class="thanhtoan"> <a href="{{ route('viewpay') }}"
                            style=" text-decoration: none;color: rgb(255, 255, 255);">Thanh Toán</a> </div>
                </div>
